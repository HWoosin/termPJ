			...
			<ul class ="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><a href="Adlogin.jsp">로그인</a></li>
						<li><a href="Adjoin.jsp">회원가입</a></li>
					</ul>
				</li>
			</ul>
			<%
		...
		<div class ="row">
			<table class="table table-striped" style="text-align; center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					%>
					<tr>
						<td><%= list.get(i).getOrNum() %></td>
						<td><a href="Orderview.jsp?ANum=<%=list.get(i).getOrNum() %>"><%= list.get(i).getOrproduct() %></a></td>
						<td><%= list.get(i).getOrID() %></td>
						
						<td><%= list.get(i).getOrDate().substring(0,11) + list.get(i).getOrDate().substring(11, 13) + "시" 
		                        + list.get(i).getOrDate().substring(14,16) + "분" %></td>
