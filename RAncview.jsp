...
%>
    ...
    <div class="container">
        <div class="row">
            ...
            <a href="Rannounce.jsp" class="btn btn-primary">목록</a>
            <%
                if(RID != null && RID.equals(anc.getAID()))
                {
            %>
                <a href="AnCupdate.jsp?QNum=<%=ANum %>" class="btn btn-primary">수정</a>
                <a href="AnCdeleteAction.jsp?QNum=<%=ANum %>" class="btn btn-primary">삭제</a>
