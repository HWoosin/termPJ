...
<title>WS Shopping QnA 관리자</title>
<style type = "text/css">
    a, a:hover
    {
        color: #000000;
			...
			<table class="table table-striped" style="text-align; center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="RQnAview.jsp?QNum=<%=list.get(i).getQNum() %>"><%= list.get(i).getQTitle() %></a></td>
			 ...
			 <%
                if(pageNumber != 1) {
            %>
                <a href="RQnA.jsp?pageNumber=<%=pageNumber - 1 %>" class="btn btn-success btn-arrow-left">이전</a>
            <%
                } if (qnaDAO.nextPage(pageNumber + 1)) {
            %>
                <a href="RQnA.jsp?pageNumber=<%=pageNumber + 1 %>" class="btn btn-success btn-arrow-left">다음</a>
            
            <%
                }
            %>
			<a href="RQnAwrite.jsp" class="btn btn-primary pull-right">글쓰기</a>
		</div>
	</div>
