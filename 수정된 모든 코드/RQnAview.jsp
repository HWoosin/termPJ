...
<%
    ...
    QnA qna = new QnADAO().getQnA(QNum);
%>
    ...
    <div class="container">
        <div class="row">
            <table class="table table-striped" style="text-align:center; border:1px solid #dddddd">
                ...
                <tbody>
                    <tr>
                        ...
                        <td colspan="2"><%= qna.getQTitle()%></td>
                    </tr>
                    <tr>
                        <td>작성자</td>
                        <td colspan="2"><%= qna.getQID()%></td>
                    </tr>
                    <tr>
                        <td>작성일자</td>
                        <td colspan="2"><%= qna.getQDate().substring(0,11) + qna.getQDate().substring(11, 13) + "시"+ qna.getQDate().substring(14,16) + "분"  %></td>
                    </tr>
                    <tr>
                        <td>내용</td>
            ...
            <a href="RQnA.jsp" class="btn btn-primary">목록</a>
            <%
                if(RID != null && RID.equals(qna.getQID()))
                {
            %>
                <a href="RQnAupdate.jsp?QNum=<%=QNum %>" class="btn btn-primary">수정</a>
                <a href="RQnAdeleteAction.jsp?QNum=<%=QNum %>" class="btn btn-primary">삭제</a>
