...
<title>WS Shopping QnA writing</title>
</head>
<body>
	<%
		String RID = null;
	...
	<div class="container">
		<div class ="row">
		<form method="post" action="RQnAwriteAction.jsp">
		<table class="table table-striped" style="text-align; center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type ="text" class="form-control" placeholder ="글 제목" name="QTitle" maxlength="50"></td>
					</tr>
					<tr>
						<td><textarea class="form-control" placeholder ="글 내용" name="QContents" maxlength="2048" style = "height: 350px"></textarea></td>
					</tr>
				</tbody>
			</table>
