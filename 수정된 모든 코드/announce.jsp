...
<title>WS Shopping Announce</title>
<style type = "text/css">
    a, a:hover
    {
        color: #000000;
			...
			<table class="table table-striped" style="text-align; center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="Ancview.jsp?ANum=<%=list.get(i).getANum() %>"><%= list.get(i).getATitle() %></a></td>
			 ...
			 <%
                if(pageNumber != 1) {
            %>
                <a href="announce.jsp?pageNumber=<%=pageNumber - 1 %>" class="btn btn-success btn-arrow-left">이전</a>
            <%
                } if (ancDAO.nextPage(pageNumber + 1)) {
            %>
                <a href="announce.jsp?pageNumber=<%=pageNumber + 1 %>" class="btn btn-success btn-arrow-left">다음</a>
